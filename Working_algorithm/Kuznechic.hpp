...
typedef uint8_t vect[BLOCK_SIZE];
 // —юда будем писать номер итерации от 1 до 32 (вообще хз зачем это)
...
void GOST_Kuz_Get_C();
static void GOST_Kuz_F(const uint8_t* in_key_1, const uint8_t* in_key_2, uint8_t* out_key_1, uint8_t* out_key_2, uint8_t* iter_const);
